...
class SubCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post :create, sub_category: { description: @sub_category.description, level: @sub_category.level, name: @sub_category.name }
    end
  ...
  test "should update sub_category" do
    patch :update, id: @sub_category, sub_category: { description: @sub_category.description, level: @sub_category.level, name: @sub_category.name }
    assert_redirected_to sub_category_path(assigns(:sub_category))
  end
